...
<label style="color: #C0C4D1;">Valida tus códigos, pon sólo lo que viene entre los corchetes XmasHack{XXXXXXXXXXXXXX==}:</label> <input type="text" name="codigo"><input type="submit" value="Sin miedo..."><br>
    <input type="hidden" value="darthvader.php" name="url">
    </form>
<?php
...
<p style="text-align: justify;">La estrella de la muerte esta cada vez más cerca del planeta y vienen a destruir a todos los seres humanos que lo habitan, es tu misión si es que decides aceptarla convertirte en el maestro Jedi del OSINT y buscar al padawan que te dará la llave de la sabiduría.
Parece que el maestro Jedi ha visto información publicada de d4rtH V4D.3R en un blog sobre una amenaza inminente al planeta tierra y esta pidiendo apoyo de los maestros Jedi más avanzados a través de uno de los sitios que siempre piden una aportación monetaria porque es un "mundo" de información</p>

<p>&nbsp;</p>

<a id="reto2"><h3>Reto 2</h3></a>
<p style="text-align: justify;">“La alianza rebelde ha logrado intervenir las comunicaciones del imperio, se cree que dentro de las comunicaciones obtenidas se encuentra la ubicacion de los planos de la estrella de la muerte. ¿Podrás ayudar a la alianza a encontrarlos?”</p>
<a href="e88968ee-d38d-46f8-9dc7-899c5ba2949d/ctf.pcap" style="color: rgb(213, 46, 46)">Descarga la comunicación intervenida</a>
<br><br>
<p>&nbsp;</p>
